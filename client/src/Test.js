...
>
  ...
  <DropboxChooser
    ...
    success={(files) => handleDropboxSuccess("histoire", files)}
    multiselect={true}
...
<div className="file-upload-section">
  ...
  <DropboxChooser
    appKey="36k1onl9bo1w0bd"
    success={(files) => handleDropboxSuccess("antecedents", files)}
    multiselect={true}
    extensions={['.pdf', '.doc', '.docx', '.xls', '.xlsx', '.txt','.gif','.pptx','.svg','.jpeg', '.jpg', '.png']}
  >
    <button className="btn btn-primary" onClick={(e)=> e.preventDefault()}>
  ...
  {/*<div className="row">
    {filesOb.filter(file => file.section === "antecedents").map(file => (
      ...
      <div className="file-upload-section">
        ...
        <DropboxChooser
          appKey="36k1onl9bo1w0bd"
          success={(files) => handleDropboxSuccess("traitement", files)}
          multiselect={true}
          extensions={['.pdf', '.doc', '.docx', '.xls', '.xlsx', '.txt','.gif','.pptx','.svg','.jpeg', '.jpg', '.png']}
        >
          <button className="btn btn-primary" onClick={(e)=> e.preventDefault()}>
      ...
      <div className="file-upload-section">
        ...
        <DropboxChooser
          appKey="36k1onl9bo1w0bd"
          success={(files) => handleDropboxSuccess("ecrt", files)}
          multiselect={true}
          extensions={['.pdf', '.doc', '.docx', '.xls', '.xlsx', '.txt','.gif','.pptx','.svg','.jpeg', '.jpg', '.png']}
        >
          <button className="btn btn-primary" onClick={(e)=> e.preventDefault()}>
...
<div className="file-upload-section">
  ...
  <DropboxChooser
    appKey="36k1onl9bo1w0bd"
    success={(files) => handleDropboxSuccess("ecg", files)}
    multiselect={true}
    extensions={['.pdf', '.doc', '.docx', '.xls', '.xlsx', '.txt','.gif','.pptx','.svg','.jpeg', '.jpg', '.png']}
  >
    <button className="btn btn-primary" onClick={(e)=> e.preventDefault()}>
...
<div className="file-upload-section">
  ...
  <DropboxChooser
    appKey="36k1onl9bo1w0bd"
    success={(files) => handleDropboxSuccess("ett", files)}
    multiselect={true}
    extensions={['.pdf', '.doc', '.docx', '.xls', '.xlsx', '.txt','.gif','.pptx','.svg','.jpeg', '.jpg', '.png']}
  >
    <button className="btn btn-primary" onClick={(e)=> e.preventDefault()}>
...
<div className="file-upload-section">
  ...
  <DropboxChooser
    appKey="36k1onl9bo1w0bd"
    success={(files) => handleDropboxSuccess("tt", files)}
    multiselect={true}
    extensions={['.pdf', '.doc', '.docx', '.xls', '.xlsx', '.txt','.gif','.pptx','.svg','.jpeg', '.jpg', '.png']}
  >
    <button className="btn btn-primary" onClick={(e)=> e.preventDefault()}>
...
<div className="file-upload-section">
  ...
  <DropboxChooser
    appKey="36k1onl9bo1w0bd"
    success={(files) => handleDropboxSuccess("coronarographie", files)}
    multiselect={true}
    extensions={['.pdf', '.doc', '.docx', '.xls', '.xlsx', '.txt','.gif','.pptx','.svg','.jpeg', '.jpg', '.png']}
  >
    <button className="btn btn-primary" onClick={(e)=> e.preventDefault()}>
...
<div className="file-upload-section">
  ...
  <DropboxChooser
    appKey="36k1onl9bo1w0bd"
    success={(files) => handleDropboxSuccess("autresExamens", files)}
    multiselect={true}
    extensions={['.pdf', '.doc', '.docx', '.xls', '.xlsx', '.txt','.gif','.pptx','.svg','.jpeg', '.jpg', '.png']}
  >
    <button className="btn btn-primary" onClick={(e)=> e.preventDefault()}>
...
<div className="file-upload-section">
  ...
  <DropboxChooser
    appKey="36k1onl9bo1w0bd"
    success={(files) => handleDropboxSuccess("biologie", files)}
    multiselect={true}
    extensions={['.pdf', '.doc', '.docx', '.xls', '.xlsx', '.txt','.gif','.pptx','.svg','.jpeg', '.jpg', '.png']}
  >
    <button className="btn btn-primary" onClick={(e)=> e.preventDefault()}>
...
<div className="file-upload-section">
  ...
  <DropboxChooser
    appKey="36k1onl9bo1w0bd"
    success={(files) => handleDropboxSuccess("cro", files)}
    multiselect={true}
    extensions={['.pdf', '.doc', '.docx', '.xls', '.xlsx', '.txt','.gif','.pptx','.svg','.jpeg', '.jpg', '.png']}
  >
    <button className="btn btn-primary" onClick={(e)=> e.preventDefault()}>
...
<div className="file-upload-section">
  ...
  <DropboxChooser
    appKey="36k1onl9bo1w0bd"
    success={(files) => handleDropboxSuccess("rxthoraxPost", files)}
    multiselect={true}
    extensions={['.pdf', '.doc', '.docx', '.xls', '.xlsx', '.txt','.gif','.pptx','.svg','.jpeg', '.jpg', '.png']}
  >
    <button className="btn btn-primary" onClick={(e)=> e.preventDefault()}>
...
<div className="file-upload-section">
  ...
  <DropboxChooser
    appKey="36k1onl9bo1w0bd"
    success={(files) => handleDropboxSuccess("ecgPost", files)}
    multiselect={true}
    extensions={['.pdf', '.doc', '.docx', '.xls', '.xlsx', '.txt','.gif','.pptx','.svg','.jpeg', '.jpg', '.png']}
  >
    <button className="btn btn-primary" onClick={(e)=> e.preventDefault()}>
...
<div className="file-upload-section">
  ...
  <DropboxChooser
    appKey="36k1onl9bo1w0bd"
    success={(files) => handleDropboxSuccess("echoscopiePost", files)}
    multiselect={true}
    extensions={['.pdf', '.doc', '.docx', '.xls', '.xlsx', '.txt','.gif','.pptx','.svg','.jpeg', '.jpg', '.png']}
  >
    <button className="btn btn-primary" onClick={(e)=> e.preventDefault()}>
...
<div className="file-upload-section">
  ...
  <DropboxChooser
    appKey="36k1onl9bo1w0bd"
    success={(files) => handleDropboxSuccess("biologiePost", files)}
    multiselect={true}
    extensions={['.pdf', '.doc', '.docx', '.xls', '.xlsx', '.txt','.gif','.pptx','.svg','.jpeg', '.jpg', '.png']}
  >
    <button className="btn btn-primary" onClick={(e)=> e.preventDefault()}>
...
<div className="file-upload-section">
  ...
  <DropboxChooser
    appKey="36k1onl9bo1w0bd"
    success={(files) => handleDropboxSuccess("gazo", files)}
    multiselect={true}
    extensions={['.pdf', '.doc', '.docx', '.xls', '.xlsx', '.txt','.gif','.pptx','.svg','.jpeg', '.jpg', '.png']}
  >
    <button className="btn btn-primary" onClick={(e)=> e.preventDefault()}>
 ...
 {/* <div className="row">
    {filesOb.filter(file => file.section === "gazo").map(file => (
      <div key={file.id} className="col-12 col-md-6 col-lg-4 mb-4">
        <div className="card shadow-sm">
          <div className="card-body">
            <div className="d-flex justify-content-between mb-3">
              <div>
                <button 
                  onClick={() => handleBoxDelete(file.id, "gazo")} 
                  className="btn btn-danger btn-sm"
                  style={{
                    display: localStorage.getItem("userName") === "Ad" ||
                      (userRole === "Médecin" && userAccessLevel === "Affichage-Modification-Suppression" && ["Cuomo","Ctcv","Cardiologie","Réanimation"]) ||
...
<div className="file-upload-section">
  ...
  <DropboxChooser
    appKey="36k1onl9bo1w0bd"
    success={(files) => handleDropboxSuccess("ecp", files)}
    multiselect={true}
    extensions={['.pdf', '.doc', '.docx', '.xls', '.xlsx', '.txt','.gif','.pptx','.svg','.jpeg', '.jpg', '.png']}
  >
    <button className="btn btn-primary" onClick={(e)=> e.preventDefault()}>
  ...
  {/*<div className="row">
    {filesOb.filter(file => file.section === "ecp").map(file => (
      <div key={file.id} className="col-12 col-md-6 col-lg-4 mb-4">
        <div className="card shadow-sm">
          <div className="card-body">
            <div className="d-flex justify-content-between mb-3">
              <div>
                <button 
                  onClick={() => handleBoxDelete(file.id, "ecp")} 
                  className="btn btn-danger btn-sm"
                  style={{
                    display: localStorage.getItem("userName") === "Ad" ||
                      (userRole === "Médecin" && userAccessLevel === "Affichage-Modification-Suppression" && ["Cuomo","Ctcv","Cardiologie","Réanimation"]) ||
...
<div className="file-upload-section">
  ...
  <DropboxChooser
    appKey="36k1onl9bo1w0bd"
    success={(files) => handleDropboxSuccess("dsr", files)}
    multiselect={true}
    extensions={['.pdf', '.doc', '.docx', '.xls', '.xlsx', '.txt','.gif','.pptx','.svg','.jpeg', '.jpg', '.png']}
  >
    <button className="btn btn-primary" onClick={(e)=> e.preventDefault()}>
 ...
 {/* <div className="row">
    {filesOb.filter(file => file.section === "dsr").map(file => (
      <div key={file.id} className="col-12 col-md-6 col-lg-4 mb-4">
        <div className="card shadow-sm">
          <div className="card-body">
            <div className="d-flex justify-content-between mb-3">
              <div>
                <button 
                  onClick={() => handleBoxDelete(file.id, "dsr")} 
                  className="btn btn-danger btn-sm"
                  style={{
                    display: localStorage.getItem("userName") === "Ad" ||
                      (userRole === "Médecin" && userAccessLevel === "Affichage-Modification-Suppression" && ["Cuomo","Ctcv","Cardiologie","Réanimation"]) ||
...
<div className="file-upload-section">
  ...
  <DropboxChooser
    appKey="36k1onl9bo1w0bd"
    success={(files) => handleDropboxSuccess("suite", files)}
    multiselect={true}
    extensions={['.pdf', '.doc', '.docx', '.xls', '.xlsx', '.txt','.gif','.pptx','.svg','.jpeg', '.jpg', '.png']}
  >
    <button className="btn btn-primary" onClick={(e)=> e.preventDefault()}>
...
<div className="file-upload-section">
  ...
  <DropboxChooser
    appKey="36k1onl9bo1w0bd"
    success={(files) => handleDropboxSuccess("suivi", files)}
    multiselect={true}
    extensions={['.pdf', '.doc', '.docx', '.xls', '.xlsx', '.txt','.gif','.pptx','.svg','.jpeg', '.jpg', '.png']}
  >
    <button className="btn btn-primary" onClick={(e)=> e.preventDefault()}>
  ...
  <div className="row">
    ...
    {filesOb.filter(file => file.section === "biologiePost").map(file => (
      <div key={file.id} className="col-12 col-md-6 col-lg-4 mb-4">
        ...
        <p><strong>Gazo:</strong> {selectedPatientForCuomo.gazo}</p>
        <div className="row">
    {filesOb.filter(file => file.section === "gazo").map(file => (
      <div key={file.id} className="col-12 col-md-6 col-lg-4 mb-4">
        <div className="card shadow-sm">
        ...
        <p><strong>ECP:</strong> {selectedPatientForCuomo.ecp}</p>
        <div className="row">
    {filesOb.filter(file => file.section === "ecp").map(file => (
      <div key={file.id} className="col-12 col-md-6 col-lg-4 mb-4">
        <div className="card shadow-sm">
        ...
        <p><strong>DSR:</strong> {selectedPatientForCuomo.dsr}</p>
        <div className="row">
    {filesOb.filter(file => file.section === "dsr").map(file => (
      <div key={file.id} className="col-12 col-md-6 col-lg-4 mb-4">
        <div className="card shadow-sm">
